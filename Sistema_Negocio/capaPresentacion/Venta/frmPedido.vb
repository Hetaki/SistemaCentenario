...
Public Class frmPedido
    ...
    Private Sub btnGrabar_Click(sender As Object, e As EventArgs) Handles btnGrabar.Click
        If txtDocumento.Text <> "" And dgDetalle.RowCount <> 0 Then
            Dim objPed As New CE.Pedido
            objPed.codPed = lblCodigo.Text
            objPed.codCli = txtCodigo.Text
            objPed.fecha = Date.Now.ToString("dd/MMMM/yyyy")
            objPed.total = lblTotal.Text
            pedDao.registraPedido(objPed)
            For Each row As DataGridViewRow In dgDetalle.Rows
                Dim objDetalle As New CE.DetallePedido
                objDetalle.idPed = lblCodigo.Text
