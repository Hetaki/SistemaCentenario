...
Public Class spRpFechaBoleta
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "capaPresentacion.spRpFechaBoleta.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedspRpFechaBoleta
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As spRpFechaBoleta = New spRpFechaBoleta()
        rpt.Site = Me.Site
        Return rpt
    End Function
