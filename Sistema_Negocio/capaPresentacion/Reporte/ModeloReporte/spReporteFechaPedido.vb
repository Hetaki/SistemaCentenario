...
Public Class spReporteFechaPedido
    ...
    Public Overrides Property ResourceName() As String
        Get
            Return "spReporteFechaPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "capaPresentacion.spReporteFechaPedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedspReporteFechaPedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As spReporteFechaPedido = New spReporteFechaPedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
