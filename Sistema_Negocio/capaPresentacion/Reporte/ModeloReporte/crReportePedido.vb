...
Public Class crReportePedido
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "capaPresentacion.crReportePedido.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReportePedido
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReportePedido = New crReportePedido()
        rpt.Site = Me.Site
        Return rpt
    End Function
