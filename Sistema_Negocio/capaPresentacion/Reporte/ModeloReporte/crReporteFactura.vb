...
Public Class crReporteFactura
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "capaPresentacion.crReporteFactura.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrReporteFactura
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crReporteFactura = New crReporteFactura()
        rpt.Site = Me.Site
        Return rpt
    End Function
